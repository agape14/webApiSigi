...
public partial class TMargesiReporte
{
    public int IdMargesiReporte { get; set; }
    ...
    public int? NumMargesi { get; set; }

    public string? GeneraRenta { get; set; }

    public DateOnly? FecIncorporacion { get; set; }
    ...
    public string? CodTitularReg { get; set; }

    public string? CodProvLuz { get; set; }

    public string? CodProvAgua { get; set; }

    public int? AnioMargesiReporte { get; set; }
